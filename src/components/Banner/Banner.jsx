...
import BannerImg from '../../assets/assets/4547829.jpg'
            ...
            <div className='flex flex-col justify-center gap-6 sm:pt-0'>
              <h1 data-aos='fade-up' className='text-3x sm:text-4xl font-bold'>
                ...
                <p data-aos='fade-up' className='text-sm text-gray-500 tracking-wide leading-5'> 
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates qui a laudantium incidunt nobis autem tempora dolore magnam. Illum eveniet iure numquam placeat commodi tenetur possimus incidunt esse quibusdam asperiores? </p>
